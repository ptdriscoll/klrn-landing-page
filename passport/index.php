...
<?php include '/../includes/landing/customContent.php'; ?>
<?php include '/../includes/landing/header.php'; ?>

<?php 
if (array_key_exists($contentKey, $customContent)) {
	if (isset($customContent[$contentKey][0])) $subHead = $customContent[$contentKey][0]; 
	if (isset($customContent[$contentKey][1])) $headline = $customContent[$contentKey][1];
}
?>
    ...
    <div id="main" class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <p class="lead">With KLRN Passport, you can access past episodes of your favorite PBS programs whenever you want using your computer, smartphone, tablet, AppleTV or Roku. See full seasons of the Great British Baking Show, Call the Midwife, Home Fires, Endeavour, The Tunnel, Poldark, Victoria and Downton Abbey. Catch up on American Experience, NOVA, Nature and Antiques Roadshow.</p>
